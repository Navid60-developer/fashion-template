...
document.addEventListener("DOMContentLoaded", function () {
    includeHTML(document.querySelector("head"), "../toppe.html");
    includeHTML(document.querySelector("header"), "../menuue.html");
    includeHTML(document.querySelector("footer"), "../Footert.html");
